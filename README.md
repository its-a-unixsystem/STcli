...
[**SillyTavern Compatibility**: `[█████████████░░░░░░░]` **65%**](docs/sillytavern-parity.md)
...
- **Modular and extensible.** The engine is a Rust library (`stcli-core`) with a CLI and a terminal UI built on top. Sandboxed WebAssembly plugins can extend prompt behavior without touching engine internals.
...
Group chat, text completion, STscript, UI extensions, and vector lore are outside the current profile. See the [parity matrix](docs/sillytavern-parity.md) for the full breakdown and the [preset reference](docs/presets.md) for field-level details.
...
| [Plugins](plugins/README.md) | Users/Devs | WebAssembly plugin system and reference component |
